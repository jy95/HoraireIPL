...
package object scala {
   ...
   */
  def sum[T <: org.jacop.core.IntVar](res: List[T], result: IntVar)(implicit m: ClassManifest[T]): Unit = {
   ...
   * @param result summation result.
   */
  def weightedSum[T <: org.jacop.core.IntVar](res: List[T], w: Array[Int], result: IntVar)(implicit m: ClassManifest[T]): Unit = {
   ...
   */
  def max[T <: org.jacop.core.IntVar](x: List[T], mx: org.jacop.core.IntVar)(implicit m: ClassManifest[T]): Unit = {
   ...
   */
  def min[T <: org.jacop.core.IntVar](x: List[T], mn: org.jacop.core.IntVar)(implicit m: ClassManifest[T]): Unit = {
   ...
   */
  def count[T <: org.jacop.core.IntVar](list: List[T], count: T, value: Int)(implicit m: ClassManifest[T]): Unit = {
   ...
   */
  def values[T <: org.jacop.core.IntVar](list: List[T], count: IntVar)(implicit m: ClassManifest[T]): Unit = {
   ...
   * @param value value selected from list of elements.
   */
  def element[T <: org.jacop.core.IntVar](index: org.jacop.core.IntVar, elements: List[T], value: org.jacop.core.IntVar)(implicit m: ClassManifest[T]): Unit = {
   ...
   * @param offset value of index offset (shift).
   */
  def element[T <: org.jacop.core.IntVar](index: org.jacop.core.IntVar, elements: List[T], value: org.jacop.core.IntVar, offset: Int)(implicit m: ClassManifest[T]): Unit = {
   ...
   * @return select method for search.
   */
  def search_split[T <: org.jacop.core.IntVar](vars: List[T], heuristic: ComparatorVariable[T])(implicit m: ClassManifest[T]) = {
   ...
   * @return related variable selection method.
   */
  def first_fail = new SmallestDomain[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def most_constrained = new MostConstrainedStatic[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def smallest_min = new SmallestMin[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def anti_first_fail = new LargestDomain[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def smallest = new SmallestMin[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def largest = new LargestMax[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def max_regret = new MaxRegret[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def indomain_min = new IndomainMin[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def indomain_max = new IndomainMax[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def indomain_middle = new IndomainMiddle[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def indomain_median = new IndomainMedian[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def indomain_random = new IndomainRandom[org.jacop.core.IntVar]
   ...
   * @return related variable selection method.
   */
  def first_fail_set = new MinCardDiff[org.jacop.set.core.SetVar]
   ...
   * @return related variable selection method.
   */
  def most_constrained_set = new MostConstrainedStatic[org.jacop.set.core.SetVar]
   ...
   * @return related variable selection method.
   */
  def min_glb_card = new MinGlbCard[org.jacop.set.core.SetVar]
   ...
   * @return related variable selection method.
   */
  def min_lub_card = new MinLubCard[org.jacop.set.core.SetVar]
   ...
   * @return related variable selection method.
   */
  def anti_first_fail_set = new MaxCardDiff[org.jacop.set.core.SetVar]
   ...
   */
  def indomain_min_set = new IndomainSetMin[org.jacop.set.core.SetVar]
   ...
   * @return related indomain method.
   */
  def indomain_max_set = new IndomainSetMax[org.jacop.set.core.SetVar]
   ...
   * @return related indomain method.
   */
  def indomain_random_set = new IndomainSetRandom[org.jacop.set.core.SetVar]
}
